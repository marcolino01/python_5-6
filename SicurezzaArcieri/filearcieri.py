...
# creazione della coppia di chivi pubblica e privata e esportazione della pubblica
...
#tramite cifrato noi abbiamo il messagio del collega scritto tramite la nostra chiave e con la funzione decrypt_message riconvertiremo il messaggio 
